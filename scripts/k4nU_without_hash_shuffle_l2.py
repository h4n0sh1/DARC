...
if __name__=="__main__": 
    ...
    dfn.to_csv("./k4nU_without_hash_shuffle.csv",index=False)
    dfa=pd.read_csv("./k4nU_without_hash_shuffle.csv")
    
    print("Checking Output format \n")
    ground_truth, submission = round1_preprocessing(
        "./ground_truth.csv", "./k4nU_without_hash_shuffle.csv"
    )
    ...
    print(scores)
    with open('scores_k4nU_without_hash_shuffle', 'wb') as fp:
