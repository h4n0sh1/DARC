...
def make_l_diverse(df_dict,partitions,l=7):
    filtered=[]
...
if __name__=="__main__": 
    ...
    dfn.to_csv("./k4nU_without_hash_l7.csv",index=False)
    dfa=pd.read_csv("./k4nU_without_hash_l7.csv")
    
    print("Checking Output format \n")
    ground_truth, submission = round1_preprocessing(
        "./ground_truth.csv", "./k4nU_without_hash_l7.csv"
    )
    ...
    print(scores)
    with open('scores_k4nU_without_hash_l7', 'wb') as fp:
